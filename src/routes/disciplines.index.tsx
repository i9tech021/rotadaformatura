          ...
          {filteredDisciplines.map((discipline) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="text-3xl mb-4 transform group-hover:scale-110 transition-transform origin-left">
                  {discipline.icone}
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-[#0A3D52]/5 flex items-center justify-between relative z-10">
                <span className="text-[10px] font-bold text-[#27AE60] uppercase">
                  Grade Curricular
                </span>
                <span className="text-[#D4941E] opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all font-black text-[10px] uppercase">
                  Acessar &rarr;
                </span>
              </div>
            </Link>
