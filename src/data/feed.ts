...
export const MOCK_FEED: FeedPost[] = [
  {
    ...
    content:
      "Alguém mais sofrendo com o EP3 de Métodos Determinísticos I? A parte de lógica tá tensa!",
    type: "question",
    likes: 12,
    comments: 5,
  ...
  },
  {
    ...
    content:
      "Acabei de subir um resumo matador sobre História do Pensamento Administrativo II na aba de materiais. Confiram lá!",
    type: "post",
    likes: 28,
    comments: 3,
