...
export const eventos: EventoAcademico[] = [
  ...
  },
  {
    ...
    peso: 0.5,
    observacoes:
      "Prazo estendido por ingresso tardio de calouros. Resolver à mão, escanear em PDF.",
    alertaDias: 7,
  },
  {
    id: "evt-mdi-ad1-q2",
  ...
  },
  {
    ...
    peso: 0.66,
    observacoes:
      "Resolver à mão, escanear em PDF. Duplicidade no cronograma oficial (30/09 e 07/10) verificar na plataforma.",
    alertaDias: 7,
  },
  {
  ...
  // ============================================================
  {
    ...
    peso: 0.66,
    observacoes:
      "Prazo final para AD2 Q3. Duplicidade no cronograma oficial (30/09 e 07/10) verificar na plataforma.",
    alertaDias: 7,
  },
  {
    id: "evt-hpa-ad2",
  ...
  // ============================================================
  {
    ...
    horario: "23:59",
    conteudo: "Aulas 1 a 7",
    observacoes: "Questionário online com 3 horas de duração, 10 questões objetivas",
    alertaDias: 7,
  },
  {
    id: "evt-gpi-ap1",
  ...
  },
  {
    ...
    horario: "11:00 às 13:00",
    local: "Polo CEDERJ",
    conteudo: "Todas as aulas (1 a 15)",
    peso: 10,
